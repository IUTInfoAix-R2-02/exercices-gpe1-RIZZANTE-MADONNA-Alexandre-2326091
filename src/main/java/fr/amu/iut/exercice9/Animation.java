...
public class Animation extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        SequentialTransition sequencesDeTransitions = new SequentialTransition(transition1, transition2, transition3,
                transition4, transition5);
        sequencesDeTransitions.setAutoReverse(true);
        sequencesDeTransitions.setCycleCount(2);

        customButton.setOnMousePressed(mouseEvent -> sequencesDeTransitions.play());
